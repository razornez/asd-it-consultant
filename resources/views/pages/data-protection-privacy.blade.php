...
@section('title', 'Data Protection & Privacy || techguru || IT Solutions & Technology Laravel Template')
@push('styles')
...
@section('content')
    <x-strickyHeader />
    <x-page-header title="Data Protection & Privacy" subtitle="Data Protection & Privacy" />
