...
@section('title', 'Threat Detection & Prevention || techguru || IT Solutions & Technology Laravel Template')
@push('styles')
...
@section('content')
    <x-strickyHeader />
    <x-page-header title="Threat Detection & Prevention" subtitle="Threat Detection & Prevention" />
