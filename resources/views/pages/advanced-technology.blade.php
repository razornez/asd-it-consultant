...
@section('content')
    <x-strickyHeader />
    <x-page-header title="Advanced Technology" subtitle="Advanced Technology" />
                        ...
                        <div class="services-details__left">
                            ...
                            <div class="services-details__need-help">
                                <div class="services-details__need-help-img">
                                    <img src="{{ asset('assets/images/services/services-details-need-help-img.jpg') }}" alt="">
                    ...
                    <div class="col-xl-8 col-lg-7">
                        <div class="services-details__right">
                            ...
                            <div class="services-details__img-1">
                                <img src="{{ asset('assets/images/services/services-details-img-6.jpg') }}" alt="">
                            </div>
