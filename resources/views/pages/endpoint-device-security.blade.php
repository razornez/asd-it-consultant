...
@section('title', 'Endpoint & Device Security || techguru || IT Solutions & Technology Laravel Template')
@push('styles')
...
@section('content')
    <x-strickyHeader />
    <x-page-header title="Endpoint & Device Security" subtitle="Endpoint & Device Security" />
                ...
                <div class="col-xl-8 col-lg-7">
                    <div class="services-details__right">
                        ...
                        <div class="services-details__img-1">
                            <img src="{{ asset('assets/images/services/services-details-img-5.jpg') }}" alt="">
                        </div>
