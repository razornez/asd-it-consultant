...
<!-- /.stricky-header -->
            ...
            <div class="swiper-container thm-swiper__slider" data-swiper-options='{"slidesPerView": 1, "loop": true,
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="main-slider-two__bg" style="background-image: url({{ asset('assets/images/backgrounds/slider-2-1.jpg') }});"></div>
                                            ...
                                            <ul class="list-unstyled main-slider__trustpilot-img-list">
                                                <li>
                                                    <div class="main-slider__trustpilot-img">
                                                        <img src="{{ asset('assets/images/resources/main-slider-trustpilot-img-1.jpg') }}" alt="">
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="main-slider__trustpilot-img">
                                                        <img src="{{ asset('assets/images/resources/main-slider-trustpilot-img-2.jpg') }}" alt="">
                                                    </div>
                                                </li>
                                            </ul>
                                            <div class="main-slider__trustpilot-content-box">
                                                <div class="main-slider__trustpilot-logo">
                                                    <img src="{{ asset('assets/images/resources/main-slider-trustpilot-logo.png') }}" alt="">
                                                </div>
                                                <div class="main-slider__trustpilot-rating-review">
                                                    <p class="main-slider__trustpilot-rating">5.0 Excellent</p>
                                                    <p class="main-slider__trustpilot-review">Reviews <span class="odometer" data-count="4170"></span> </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="main-slider-two__content">
                                        <div class="main-slider-two__sub-title-box">
                                            <div class="main-slider-two__sub-title-icon">
                                                <img src="{{ asset('assets/images/icon/main-slider-sub-title-icon.png') }}" alt="">
                                            </div>
                                        ...
                                        <div class="main-slider-two__btns-box">
                                            ...
                                            <div class="main-slider-two__btn-box-2">
                                                <a href="{{ route('about') }}" class="thm-btn">Read More<span class="icon-right-arrow"></span></a>
                                            </div>
                                        </div>
                                        <div class="main-slider-two__shield-check-icon">
                                            <img src="{{ asset('assets/images/icon/main-slider-shield-check-icon.png') }}" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="main-slider-two__bg" style="background-image: url({{ asset('assets/images/backgrounds/slider-2-2.jpg') }});"></div>
                        <ul class="list-unstyled main-slider-two__menu">
                            <li><a href="{{ route('about') }}">Help</a></li>
                            <li><a href="{{ route('contact') }}">Support</a></li>
                            <li><a href="{{ route('faq') }}">Faqs</a></li>
                    ...
                    <div class="swiper-slide">
                        <div class="main-slider-two__bg" style="background-image: url({{ asset('assets/images/backgrounds/slider-2-3.jpg') }});"></div>
                        <ul class="list-unstyled main-slider-two__menu">
                            <li><a href="{{ route('about') }}">Help</a></li>
                            <li><a href="{{ route('contact') }}">Support</a></li>
                            <li><a href="{{ route('faq') }}">Faqs</a></li>
                    ...
                    <div class="col-xl-6">
                        <div class="about-two__left">
                            ...
                            <div class="about-two__client-box">
                                <ul class="about-two__client-img-list list-unstyled">
                                    <li>
                                        <div class="about-two__client-img">
                                            <img src="{{ asset('assets/images/resources/about-two-client-img-1-1.jpg') }}" alt="">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="about-two__client-img">
                                            <img src="{{ asset('assets/images/resources/about-two-client-img-1-2.jpg') }}" alt="">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="about-two__client-img">
                                            <img src="{{ asset('assets/images/resources/about-two-client-img-1-3.jpg') }}" alt="">
                                        </div>
                                    </li>
                                    <li>
                                ...
                                <p class="about-two__client-text"><span class="odometer" data-count="120">00</span><span>K</span> Satisfied Client</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6">
                        <div class="about-two__right">
                            ...
                            <div class="about-two__experience-contact-and-btn">
                                ...
                                <div class="about-two__btn-box">
                                    <a href="{{ route('about') }}" class="thm-btn">Learn More<span class="icon-right-arrow"></span></a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="counter-two">
            <div class="counter-two__bg-shape" style="background-image: url({{ asset('assets/images/shapes/counter-two-bg-shape.png') }});"></div>
            <div class="container">
                <div class="row">
                        ...
                        <div class="why-choose-one__left">
                            ...
                            <div class="why-choose-one__btn-and-client-info">
                                <div class="why-choose-one__btn-box">
                                    <a href="{{ route('about') }}" class="thm-btn">About Us<span class="icon-right-arrow"></span></a>
                                </div>
                                <div class="why-choose-one__client-box">
                                    <div class="why-choose-one__client-img">
                                        <img src="{{ asset('assets/images/resources/why-choose-one-client-img.jpg') }}" alt="">
                                    </div>
        ...
        <section class="process-two">
            <div class="process-two__bg" style="background-image: url({{ asset('assets/images/backgrounds/process-two-bg.jpg') }});">
            </div>
            <div class="process-two__bg-shape float-bob-y" style="background-image: url({{ asset('assets/images/shapes/process-two-bg-shape.png') }});">
            </div>
            <div class="container">
                                ...
                                <ul class="portfolio-two__box list-unstyled">
                                    <li>
                                        <div class="portfolio-two__box-content">
                                            ...
                                            <div class="portfolio-two__title">
                                                <h3><a href="{{ route('portfolio-details') }}">Innovative Solutions,<br> Powerful
                                                        Results</a></h3>
                                            </div>
                                            <div class="portfolio-two__content-box">
                                                ...
                                                <div class="portfolio-two__title-box">
                                                    <h3 class="portfolio-two__title-2"><a href="{{ route('portfolio-details') }}">Innovative Solutions,<br>
                                                            Powerful
                                                            Results</a></h3>
                                    ...
                                    <li class="active">
                                        <div class="portfolio-two__box-content">
                                            ...
                                            <div class="portfolio-two__title">
                                                <h3><a href="{{ route('portfolio-details') }}">Transforming Ideas Into<br> Digital
                                                        Excellence</a></h3>
                                            </div>
                                            <div class="portfolio-two__content-box">
                                                <div class="portfolio-two__icon">
                                                ...
                                                <div class="portfolio-two__title-box">
                                                    <h3 class="portfolio-two__title-2"><a href="{{ route('portfolio-details') }}">Transforming Ideas Into
                                    ...
                                    <li>
                                        <div class="portfolio-two__box-content">
                                            ...
                                            <div class="portfolio-two__content-box">
                                                ...
                                                <div class="portfolio-two__title-box">
                                                    <h3 class="portfolio-two__title-2"><a href="{{ route('portfolio-details') }}">Driving Success Through
                                                            Technology</a></h3>
                                                    <p class="portfolio-two__text">Explore How We've Empowered
                                                        Businesses with Innovative Tech Solutions</p>
                                                </div>
                                    ...
                                    <li>
                                        <div class="portfolio-two__box-content">
                                            ...
                                            <div class="portfolio-two__content-box">
                                                ...
                                                <div class="portfolio-two__title-box">
                                                    <h3 class="portfolio-two__title-2"><a href="{{ route('portfolio-details') }}">Empowering Businesses with
                                                            Cutting-Edge IT</a></h3>
                                                    <p class="portfolio-two__text">Explore How We've Empowered
                                                        Businesses with Innovative Tech Solutions</p>
                                                </div>
                                    ...
                                    <div class="col-xl-4 col-lg-6">
                                        <div class="pricing-two__single pricing-two__single-1">
                                            ...
                                            <div class="pricing-two__btn-box">
                                                <a href="{{ route('pricing') }}" class="pricing-two__btn">Choose Plan<span class="far fa-plus-circle"></span></a>
                                            </div>
        ...
        <section class="contact-two" id="contact">
            ...
            <div class="contact-two__bg" style="background-image: url({{ asset('assets/images/backgrounds/contact-two-bg.jpg') }});">
            </div>
            ...
            <div class="container">
                <div class="event-one__top">
                    ...
                    <div class="event-one__top-btn-box">
                        <a href="{{ route('contact') }}" class="thm-btn">Contact Us<span class="icon-right-arrow"></span></a>
                    </div>
                </div>
                                ...
                                <div class="event-one__single wow fadeInLeft" data-wow-delay="100ms">
                                                ...
                                                <div class="countdown-timer">
                                                    <div class="default-coundown">
                                                        <div class="default-coundown-box">
                                                            <div class="countdown event-one-countdown" data-countdown-time="2025/05/28">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="event-one__meta-and-btn-box">
                                        ...
                                        <div class="event-one__btn-box">
                                            <a href="{{ route('contact') }}" class="event-one__btn">Book Seat<span class="icon-right-arrow"></span></a>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="event-one__countdown-box">
                                            <div class="timer-box clearfix">
                                                <div class="countdown-timer">
                                                    <div class="default-coundown">
                                                        <div class="default-coundown-box">
                                                            <div class="countdown event-one-countdown" data-countdown-time="2025/07/28">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="event-one__countdown-box">
                                            <div class="timer-box clearfix">
                                                <div class="countdown-timer">
                                                    <div class="default-coundown">
                                                        <div class="default-coundown-box">
                                                            <div class="countdown event-one-countdown" data-countdown-time="2025/09/28">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                    ...
                    <div class="col-xl-6">
                        <div class="blog-two__left wow fadeInLeft" data-wow-delay="100ms">
                            ...
                            <div class="blog-two__top-btn-box">
                                <a href="{{ route('blog-details') }}" class="thm-btn">View All Blogs<span class="icon-right-arrow"></span></a>
                            </div>
                                    ...
                                    <div class="blog-two__content">
                                        <div class="blog-two__user">
                                            <div class="blog-two__user-img">
                                                <img src="{{ asset('assets/images/blog/blog-two-user-1.jpg') }}" alt="">
                                            </div>
                                        ...
                                        <h3 class="blog-two__title"><a href="{{ route('blog-details') }}">The Future is Now: A
                                        ...
                                        <div class="blog-two__btn-box">
                                            <a href="{{ route('blog-details') }}" class="thm-btn">Reed More<span class="icon-right-arrow"></span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="blog-two__right">
                            ...
                            <div class="blog-two__single-two wow fadeInLeft" data-wow-delay="100ms">
                                ...
                                <div class="blog-two__content-two">
                                    ...
                                    <h3 class="blog-two__title-two"><a href="{{ route('blog-details') }}">5 Key Trends Shaping the
                                            Future of Technology</a></h3>
                                    <ul class="blog-two__meta-two list-unstyled">
                                        <li>
                                            <a href="{{ route('blog-details') }}"><span class="far fa-calendar-alt"></span>Jan 13,
                                                2025</a>
                                        </li>
                                        <li>
                            ...
                            <div class="blog-two__single-two wow fadeInLeft" data-wow-delay="300ms">
                                ...
                                <div class="blog-two__content-two">
                                    ...
                                    <h3 class="blog-two__title-two"><a href="{{ route('blog-details') }}">The Ultimate Guide to
